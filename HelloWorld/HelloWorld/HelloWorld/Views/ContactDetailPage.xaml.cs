...
namespace HelloWorld.Views
{
    ...
    public partial class ContactDetailPage : ContentPage
    {
        ...
        public event EventHandler<ContactNew> ContactAdded;
        public event EventHandler<ContactNew> ContactUpdated;

        public ContactDetailPage(ContactNew contact)
        {
        ...
        {
            var contact = BindingContext as ContactNew;
